...
# Directori NginxProxyManager
directory="/root/nginxProxyManager"
...
if [ ! -f "$docker_compose_file" ]; then
 ...
 wget https://raw.githubusercontent.com/Otorexer/SerLliure/main/Serveis/NginxProxyManager/docker-compose.yml -O "$docker_compose_file"
else
